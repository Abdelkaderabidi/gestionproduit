...
public class ServicesCategorie implements ICategorie<Categorie, Produit> {
    ...
    public void addCat(Categorie categorie) {
        String qry = "INSERT INTO `categorie`(nom_cat) VALUES (?)";
        try {
    ...
    public void updateCat(Categorie categorie) {
        ...
        try {
            ...
            String qry = "UPDATE `categorie` SET  `nom_cat` = ?  WHERE `id_cat` = ";
    ...
    public Categorie trouver_cat_par_id(int id){
        ...
        try {
            String qry = "SELECT * FROM `categorie` WHERE id_cat = ?";
            PreparedStatement stm = cnx.prepareStatement(qry);
            stm.setInt(1,id);
    ...
    public void modifier_categorie(int id, String newNom) {
        try {
            ...
            String requete = "UPDATE categorie SET nom_cat = ? WHERE id_cat ="+id;
    ...
    public Categorie trouver_categorie_par_id(int id) {
        Categorie c = null;
        try {
            String requete = "SELECT * FROM categorie WHERE id_cat = ?";
            PreparedStatement pst = cnx.prepareStatement(requete);
            pst.setInt(1, id);
    ...
    public void supprimer_categorie(int id) {
        ...
        String qry = "DELETE FROM `categorie` WHERE id_cat = ?";
        try {
            PreparedStatement stm = cnx.prepareStatement(qry);
            stm.setInt(1, id);
            stm.executeUpdate();
